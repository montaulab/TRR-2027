...
\newcommand{\customPanelLeft}[3][\linewidth]{
    \noindent
    \begin{minipage}[t]{#1}
        \vspace{0pt}
        \centering
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{car/structure.png}
	\caption{Structure aluminium de la voiture}
\end{figure}

\newpage

\section{Les roues mecanum}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{wheel/wheel.jpg}
	\caption{Roues Omnidirectionnelle Mecanum}
\end{figure}

\customPanelLeft[0.1\textwidth]{wheel/front.png}{
  Ces roues omnidirectionnelles possèdent des rouleaux orientés à 45°, ce qui permet de créer tous les mouvements que l'on souhaite en faisant tourner les bommes roues dans les bon sens.
}
